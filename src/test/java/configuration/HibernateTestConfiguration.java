...
public class HibernateTestConfiguration {
    ...
    static {
        ...
        hibernateProperties.setProperty("hibernate.connection.url", "jdbc:h2:mem:job_list_test;INIT=CREATE SCHEMA IF NOT EXISTS job_list_test"); //mem = база у нас в памяти
